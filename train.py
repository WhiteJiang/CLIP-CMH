...
def main():
    ...
    def test(epoch, is_eval=True):
        ...
        print(retrieval_txts.shape, retrieval_labs.shape, query_imgs.shape, query_labs.shape)
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        torch.save(state, os.path.join(args.ckpt_dir, '{}_checkpoint.t7'.format(epoch)))
        if avg == best_acc:
            image_model_state_dict = image_model.state_dict()
